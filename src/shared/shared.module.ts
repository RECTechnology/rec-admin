...
import { ProductsTabComponent } from 'src/pages/b2b/entities/components/products/products.tab';
import { ActivitiesTabComponent } from 'src/pages/b2b/entities/components/activities/activities.tab';
import { NeighborhoodsTabComponent } from 'src/pages/b2b/entities/components/neighborhoods/neighborhoods.tab';
import {
...
import { DocumentKindsTabComponent } from 'src/pages/b2b/entities/components/document_kinds/document-kinds.tab';
import { DocumentTabComponent } from 'src/pages/b2b/entities/components/documents/documents.tab';
import { TiersTabComponent } from 'src/pages/b2b/entities/components/tiers/tiers.tab';
...
import { AddItemDia } from 'src/pages/b2b/entities/add-item/add-item.dia';
import { AddNeighbourhoodDia } from 'src/pages/b2b/entities/components/neighborhoods/add/add.dia';
...
import { EditAccountsDia } from 'src/pages/change_delegate/components/edit_users/edit_accounts.dia';
